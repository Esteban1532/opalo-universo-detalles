      ...
      {!modalCarritoAbierto && !modalWhatsAppAbierto && (
        <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-40 flex items-end gap-2 sm:gap-3 pointer-events-auto">
          ...
          <a 
            ...
            className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#25D366] shadow-xl shadow-green-300/50 flex items-center justify-center text-white hover:scale-110 transition-all border-2 border-white cursor-pointer shrink-0"
