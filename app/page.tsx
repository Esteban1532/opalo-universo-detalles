      ...
      {!modalCarritoAbierto && !modalWhatsAppAbierto && (
        <div className="fixed bottom-6 right-6 z-40 flex items-end gap-3 pointer-events-auto">
          ...
          <a 
            ...
            className="w-14 h-14 rounded-full bg-[#25D366] shadow-xl shadow-green-300/50 flex items-center justify-center text-white hover:scale-110 transition-all border-2 border-white cursor-pointer"
            ...
            onClick={() => {
              ...
              const frases = usuarioActivo 
                ...
                : [
                    ...
                    "¿Necesitas ayuda? ¡Toca el icono de WhatsApp a mi lado! 💬"
                  ];
